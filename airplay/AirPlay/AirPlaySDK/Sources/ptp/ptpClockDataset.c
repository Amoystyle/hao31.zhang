...
#define B_BETTER false
...
#if (DEBUG)
    PTP_LOG_INFO("%s: Clock A -> gmID:%016llx priority1:%3d qualityClass:%3d qualityAccuracy:%3d logVariance:%3d priority2:%3d stepsRemoved:%d",
        __func__,
    ...
    PTP_LOG_INFO("%s: Clock B -> gmID:%016llx priority1:%3d qualityClass:%3d qualityAccuracy:%3d logVariance:%3d priority2:%3d stepsRemoved:%d",
        __func__,

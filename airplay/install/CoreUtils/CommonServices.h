...
#define __PROGRAM__ cfGetprogname()
#else
#define __PROGRAM__ ""
#endif
...
#endif
STATIC_INLINE const char* cfGetprogname(void)
{
    return (__progname);
}
#endif
